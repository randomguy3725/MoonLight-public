                    ...
                    if (customRotationSetting.get()) {
                        switch (calcRotSpeedMode.get()) {
                            case "Linear":
                                ...
                                break;
                            case "Acceleration":
                                RotationUtils.setRotation(finalRotation, moveFix.get() ?  MovementCorrection.SILENT : MovementCorrection.OFF, maxAcceleration.get(), accelerationError.get(), constantError.get(), smoothlyResetRotation.get());
                                break;
                        }
                    } else {
