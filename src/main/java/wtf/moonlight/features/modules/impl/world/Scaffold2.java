...
public class Scaffold2 extends Module {
    ...
    private final ModeValue mode = new ModeValue("Mode", new String[]{"Normal", "Telly", "Watchdog", "God Bridge"}, "Normal", this);
    ...
    private final BoolValue unPatch = new BoolValue("Un Patch Test", true, this, () -> mode.is("Watchdog") && addons.isEnabled("Sprint") && addons.isEnabled("Keep Y"));
    ...
    public final ModeValue lowMode = new ModeValue("Low Hop", new String[]{"None","8 Tick","7 Tick"}, "7 Tick", this, () -> mode.is("Watchdog") && addons.isEnabled("Sprint") && addons.isEnabled("Keep Y"));
    ...
    public void onUpdate(UpdateEvent event) {
        ...
        if (addons.isEnabled("Snap") && PlayerUtils.getBlock(targetBlock) instanceof BlockAir || !addons.isEnabled("Snap")) {
    ...
    private void place(BlockPos pos,EnumFacing facing,Vec3 hitVec) {
        ...
        if (addons.isEnabled("Ray Trace")) {
            ...
            previousBlock = data.blockPos.offset(data.getEnumFacing());
        } else {
